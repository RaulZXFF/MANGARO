...
(function () {
  ...
  const depth = Math.max(pathParts.length - (hasTrailingSlash ? 0 : 1), 0);
  const rootPrefix = depth ? "../".repeat(depth) : "./";
  const seriesBasePath = `${rootPrefix}Kagurabachi/`;
  ...
  menuToggle.setAttribute("aria-label", "Deschide meniul de capitole");
  menuToggle.innerHTML = `
    <span class="menu-toggle__icon" aria-hidden="true"></span>
    <span class="menu-toggle__label">Capitole</span>
  `;
  ...
  slideMenu.innerHTML = `
    ...
    <div class="slide-menu__body">
      <ul class="slide-menu__section slide-menu__section--primary">
        ${staticItems}
      </ul>
      <h4 class="slide-menu__section-title">Capitole</h4>
